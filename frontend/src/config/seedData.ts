    ...
    nodes: [
      {
        ...
        doc: {
          ...
          rules: [{ description: 'Tanggal mulai harus lebih besar dari hari ini' }],
      ...
      },
      {
        ...
        doc: {
          ...
          rules: [{ description: 'Saldo cuti tahunan tidak boleh kurang dari nol' }],
      ...
      },
      {
        ...
        doc: {
          ...
          rules: [{ description: 'Harus diselesaikan dalam waktu maksimal 24 jam kerja' }],
      ...
      },
      {
        ...
        doc: {
          ...
          rules: [{ description: 'Sistem langsung menolak tanpa peninjauan manual manager' }],
