    ...
    nodes: [
      {
        ...
        roles: {
          ...
          frontend: {
            ...
            route: '/leave/request',
            framework: 'React',
            link: 'https://github.com/flowak/fe/components/LeaveRequestForm',
          },
          backend: {
            assignee: 'Budi',
            status: 'done',
      ...
      },
      {
        ...
        roles: {
          ...
          frontend: {
            assignee: 'Siti',
            status: 'planned',
            component: 'ManagerApprovalCard.tsx',
      ...
      },
      {
        ...
        roles: {
          ...
          frontend: {
            assignee: 'Siti',
            status: 'done',
            component: 'LeaveRejectionBanner.tsx',
